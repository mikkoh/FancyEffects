define(['Class',
	'lib/FancyEffects/src/PropertyNumber',
	'lib/FancyEffects/src/PropertyNumberWhole',
	'lib/FancyEffects/src/PropertyFilter',
	'lib/FancyEffects/src/PropertyColour',
	'lib/FancyEffects/src/PropertyBoxShadow'
	], function(Class, PropertyNumber, PropertyNumberWhole, PropertyFilter, PropertyColour, PropertyBoxShadow){
	...
	var ParserBase = new Class({
		...
		_clone: function(obj) {
			...
			var ret = Object.create( this._propertyType.prototype );
			ret = ( this._propertyType.apply( this._value, propValues ) || this._value );
			return ret;
		},
